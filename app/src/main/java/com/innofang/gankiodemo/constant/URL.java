...
public class URL {
    ...
    public static final String DATA_LUCK = "http://gank.io/api/data/福利/10/";

    // 随机数据，请求随机妹子图个数：1
    public static final String DATA_RANDOM_MEIZHI = "http://gank.io/api/random/data/%E7%A6%8F%E5%88%A9/1";

    // 分类数据，获取指定分类数据，个数：指定，页数：1
    public static String getCategoryData(String category, int page){
        return "http://gank.io/api/data/" + category + "/15/" + page;
    }
    // 分类数据，获取指定分类数据，个数：指定，页数：1
